    ...
    function doRequest() {
      ...
      request.post(requestOptions, function onResponse(err, res, body) {
        if (err || res.statusCode !== 200) {
          const attemptNum = module.exports.MAX_ATTEMPTS_NUMBER - attemptsNum + 1;
          const duration = Date.now() - requestStart;
          tracer.info(err, `Request attempt ${attemptNum} to authentication service at ${requestOptions.url} failed in ${duration} ms.`);
          --attemptsNum;
          if (!attemptsNum) {
